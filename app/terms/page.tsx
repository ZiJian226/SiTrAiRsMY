            ...
            <div className="prose max-w-none space-y-8">
              <section className="card bg-base-200 p-6">
                ...
                <p className="opacity-80">
                  By accessing and using StarMyriad platform, you accept and agree to be bound by these Terms of Service
              ...
              <section className="card bg-base-200 p-6">
                ...
                <p className="opacity-80 mb-4">
                  StarMyriad provides a platform that:
                </p>
              ...
              <section className="card bg-base-200 p-6">
                ...
                <h3 className="text-xl font-semibold mb-3">Registration (StarMyriad Talent Only)</h3>
                <p className="opacity-80 mb-4">
              ...
              <section className="card bg-base-200 p-6">
                ...
                <p className="opacity-80">
                  By posting content on StarMyriad, you grant us a non-exclusive, worldwide, royalty-free license to
              ...
              <section className="card bg-base-200 p-6">
                ...
                <p className="opacity-80 mb-4">
                  StarMyriad facilitates connections between users and artists but is not party to commission agreements.
                </p>
                <ul className="list-disc list-inside space-y-2 opacity-80 ml-4">
                  ...
                  <li>StarMyriad is not responsible for the quality or delivery of commissioned work</li>
              ...
              <section className="card bg-base-200 p-6">
                ...
                <p className="opacity-80 mb-4">
                  All content on StarMyriad, including but not limited to:
                </p>
                <ul className="list-disc list-inside space-y-2 opacity-80 ml-4">
                  <li>Platform design and functionality</li>
                  <li>StarMyriad branding and logos</li>
                  <li>Original content created by StarMyriad</li>
                </ul>
                <p className="opacity-80 mt-4">
                  ...are owned by StarMyriad or our licensors and protected by copyright and trademark laws.
                </p>
              </section>
              ...
              <section className="card bg-base-200 p-6">
                ...
                <p className="opacity-80 mb-4">
                  Currently, StarMyriad is free to use for basic features. We reserve the right to:
                </p>
                <ul className="list-disc list-inside space-y-2 opacity-80 ml-4">
              ...
              <section className="card bg-base-200 p-6">
                ...
                <p className="opacity-80 mb-4">
                  StarMyriad is provided "as is" without warranties of any kind, express or implied.
                </p>

                <h3 className="text-xl font-semibold mb-3">Limitation of Liability</h3>
                <p className="opacity-80">
                  To the maximum extent permitted by law, StarMyriad shall not be liable for any indirect, incidental,
              ...
              <section className="card bg-base-200 p-6">
                ...
                <p className="opacity-80">
                  You agree to indemnify and hold StarMyriad harmless from any claims, damages, or expenses arising from
              ...
              <section className="card bg-base-200 p-6">
                ...
                <p className="opacity-80">
                  ...
                  via email or platform notification. Continued use of StarMyriad after changes constitutes acceptance

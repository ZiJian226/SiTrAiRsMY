          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="card bg-gradient-to-br from-primary to-secondary shadow-2xl">
              <div className="card-body items-center text-center">
                ...
                <h2 className="text-3xl font-bold mb-2">Join Our Discord Server</h2>
                <p className="text-lg opacity-90 mb-6">
                  Connect with the StarWeaver community on Discord! 
                  Chat, share content, and participate in exclusive events.
                </p>
                <a 
                  href="https://discord.gg/starweaver" 
                  target="_blank" 
                ...
                <p className="text-sm opacity-75 mt-4">
                  Note: Replace the Discord invite link with your actual StarWeaver community link
                </p>
              </div>
            </div>

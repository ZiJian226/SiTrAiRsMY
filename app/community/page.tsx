      ...
      <div className="relative z-10">
        ...
        <Container className="py-12 flex-grow">
          ...
          <p className="text-center text-lg mb-12 max-w-2xl mx-auto opacity-70">
            Join StarWeaver - our public community space for non-StarMy members, collaborations, and sharing creative content.
          </p>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="card bg-base-200 shadow-xl">
              <div className="card-body">
                <h2 className="card-title text-2xl text-primary mb-4">What is StarWeaver?</h2>
                <p className="text-lg opacity-80 leading-relaxed">
                  While StarMy is primarily for internal StarMy members (VTubers and artists), 
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="card bg-base-200 shadow-xl">
                <div className="card-body">
                  ...
                  <p className="opacity-70">
                    Get the latest news, event announcements, and updates from StarMy talents.
                  </p>
                </div>
              </div>
            ...
            <div className="card bg-gradient-to-br from-primary to-secondary shadow-2xl">
              <div className="card-body">
                <h2 className="text-3xl font-bold text-center mb-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 71 55" fill="none">
                    <path 
                  ...
                  Application to Join StarWeaver Discord
                </h2>
                <div className="text-center mb-6">
                  <p className="text-lg opacity-90 mt-2">Exclusive to Malaysia — please provide your Discord name to join.</p>
                </div>
                ...
                {submitted ? (
                  <div className="alert alert-success max-w-2xl mx-auto">
                    ...
                    <span>Application submitted successfully! We'll review your application and get back to you soon.</span>
                  </div>
                ) : (
                  <>
                    {error && (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl mx-auto">
                      <div className="form-control">
                        <label className="label"><span className="label-text font-semibold text-white">Full Name *</span></label>
                        <input 
                          type="text" 
                          name="name" 
                      ...
                      <div className="form-control">
                        <label className="label"><span className="label-text font-semibold text-white">Discord Name (e.g. Poffu#1234) *</span></label>
                        <input 
                          type="text" 
                          name="discordName" 
                      ...
                      <div className="form-control">
                        <label className="label">
                          <span className="label-text font-semibold text-white">Tell us about yourself *</span>
                          <span className="label-text-alt text-white opacity-70">Your background, interests, and why you want to join</span>
                        </label>
                        <textarea 
                          name="supportingInfo" 
                      ...
                      <div className="form-control">
                        <label className="cursor-pointer label">
                          ...
                          <span className="label-text ml-3 text-white">I confirm I am based in Malaysia *</span>
                        </label>
                      </div>
                      <div className="form-control">
                        ...
                        <button type="submit" className="btn btn-lg bg-white text-primary hover:bg-gray-100 border-none w-full" disabled={loading}>
                          {loading ? (
                            <>
            ...
            <div className="card bg-base-200 shadow-xl">
              <div className="card-body">
                <h2 className="card-title text-2xl text-primary mb-4">Community Guidelines</h2>
                <ul className="space-y-2 opacity-80">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">✓</span>
                    <span>Follow Discord's Terms of Service and Community Guidelines</span>
                  </li>
                </ul>
              </div>
            </div>
